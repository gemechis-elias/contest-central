...
import '../statistics/contest_statistics.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        // Here we take the value from the ESquadDashBoard object that was created by
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ContestStatistics(),
                  ),
                );
              },
